...
{
    public partial class MSKP90020A_POP : CSIGMESBaseform6 
    {
        #region Variable
        ...
        private DataTable GetData(string argType)
        {
            try
            {
                ...
                else
                {
                    ...
                    dtData = proc.SetParamData(dtData, argType, _factory, _plant, cboMonth.yyyymmdd);
                }
